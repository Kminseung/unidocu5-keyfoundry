 ...
 */
define([
    // 'stache!vendorCustom/keyfoundry/mustache/amountDisplayWrapper',
    // 'stache!vendorCustom/keyfoundry/mustache/approvalDbdata',
    ...
    embedStatementZUNIEFI_6732_Keyfoundry_overseeTemplate
        ...
        return function () {
            ...
            window.$kms_temp_function = {};

            $kms_temp_function.hideOneClickTemplate = function () {
...
//             }
//         };
//         $keyfoundry.generateZUNIEWF_6732StatementFn = function(doc_kinds) {
//             return function(grono,reqno) {
//                 var template;
//                 if(doc_kinds === 'A') template = $ewf.mustache.embedStatementZUNIEFI_6732_Keyfoundry_domesticTemplate;
//                 else if(doc_kinds === 'B') template = $ewf.mustache.embedStatementZUNIEFI_6732_Keyfoundry_overseeTemplate;
...
//                 var $el = $(template($keyfoundry.getStacheView_ZUNIEFI_6732(zuniefi_6732_nsReturn)));
...
//             }
//         };
        $keyfoundry.getStacheView_ZUNIEFI_6732 = function(zuniefi_6732_nsReturn){
...
//                 $urllink = $('.statement-reqno-link');
//             } else {
//                 $urllink = $('.statement-url-link');
//             }
//
...
//                         data[key.toUpperCase()] = value;
//                     });
//                     $keyfoundry.urlClickHandler(data);
//                 });
//             }
...
//         };
        ...
        // $keyfoundry.urlClickHandler = function (paramMap) {
        //     var hasReqno = $u.page.getPageParams().hasOwnProperty("REQNO");
        //     var $reqno = $u.page.getPageParams().REQNO;
        //     if(hasReqno && $reqno.length > 1 ){
        ...
        //             else $keyfoundry.openUrlDialog(ot_data);
        //         });
        //     }else {
        ...
        // $keyfoundry.openUrlDialog = function (ot_data) {
        ...
        //     $keyfoundry.openApproval(gridObj);
        // }
//
...
//         }
//
//         $keyfoundry.openApproval = function (gridObj) {
...
//             'uni-e-approval/view/DRAFT_0010',k
